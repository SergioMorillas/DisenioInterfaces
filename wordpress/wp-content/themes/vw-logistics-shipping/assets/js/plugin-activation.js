jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_logistics_shipping_plugin_activate_plugin;


    $(document).on('click', '.vw-logistics-shipping-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-logistics-shipping-plugin-install');
                button.addClass('button-primary vw-logistics-shipping-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-logistics-shipping-recommended-plugins .vw-logistics-shipping-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-logistics-shipping-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-logistics-shipping-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-logistics-shipping-recommended-plugins').css('display','none');
    });
